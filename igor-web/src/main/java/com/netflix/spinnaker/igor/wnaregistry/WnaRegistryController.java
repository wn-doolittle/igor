...
public class WnaRegistryController {
  private final BuildServices buildServices;

  public WnaRegistryController(BuildServices buildServices) {
  ...
  private Optional<WnaRegistryService> getService(String buildMaster) {
    return Optional.ofNullable((WnaRegistryService) buildServices.getService(buildMaster));
  }
}
